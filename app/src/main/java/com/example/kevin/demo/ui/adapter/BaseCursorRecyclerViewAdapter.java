...
public abstract class BaseCursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements Filterable,
  ...
  public BaseCursorRecyclerViewAdapter(Context context, Cursor cursor, ItemClickListener<VH> clickListener) {
   ...
   * @param context The context This option is discouraged, as it results in Cursor queries being performed on the application's UI thread and thus
   * can cause poor responsiveness or even Application Not Responding errors.  As an alternative, use {@link android.app.LoaderManager} with a {@link
   ...
   * @param flags Flags used to determine the behavior of the adapter; Currently it accept {@link #FLAG_REGISTER_CONTENT_OBSERVER}.
   */
   ...
   *
   * @return Returns the previously set Cursor, or null if there wasa not one. If the given new Cursor is the same instance is the previously set
